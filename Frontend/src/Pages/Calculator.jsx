...
const Calculator = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl leading-relaxed">
              Get a detailed breakdown of your estimated range, efficiency
              score, battery stress level, and energy consumption based on real
              driving conditions.
            </p>
          </div>
                ...
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="text-xs px-3 py-1.5 rounded-full border border-[#44ACFF]/30 text-[#44ACFF] hover:bg-[#44ACFF]/10 transition-colors"
                      >
                        Share ↗
                      </button>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <StatsCard
                      ...
                      value={
                        EVresult.data.drivingCondition
                          ? EVresult.data.drivingCondition
                              .charAt(0)
                              .toUpperCase() +
                            EVresult.data.drivingCondition.slice(1)
                          : "N/A"
                      }
                    />
                  </div>
      ...
      {share && (
        <ShareCard results={EVresult?.data} onClose={() => setShare(false)} />
      )}
    </>
  );
};
