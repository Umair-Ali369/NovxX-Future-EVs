  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <p className={typography.eyeBrow}> The Process </p>
        <h2 className={typography.h2}> How NovxX Works? </h2>
        <div
          ref={cardsref}
          className="reveal-child grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6"
        >
          {STEPS.map((step, i) => (
            <div key={step.num} className="relative">
              <div
                className={`${card.hover} card-lift p-6 flex flex-col gap-3 h-full`}
              >
